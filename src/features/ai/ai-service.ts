...
function buildSystemPrompt(context: AiRequestContext): string {
  ...
  return [
    ...
    "Tu peux utiliser des emojis quand ils apportent du ton ou de la clarte, mais sans en abuser: 1 a 3 emojis max dans une reponse courte, et des emojis pertinents seulement.",
